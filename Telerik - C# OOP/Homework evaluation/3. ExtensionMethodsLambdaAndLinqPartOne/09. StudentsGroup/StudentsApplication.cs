...
namespace StudentsGroup
{
    ...
    {
        public static Students sampleStudent1 = new Students(
        ...
        public static Students sampleStudent2 = new Students(
        ...
        public static Students sampleStudent3 = new Students(
        ...
        public static Students sampleStudent4 = new Students(
        ...
        public static List<Students> sampleStudents = new List<Students> { sampleStudent1, sampleStudent2, sampleStudent3, sampleStudent4 };
        ...
        static void Main()
        {
            ...
            foreach (Students student in studentsWithPhonesInSofia)
            {
                Console.WriteLine(student);
                Console.WriteLine();
            }
